<template>
  <div class="realgrid-vue-wrapper w-100 d-flex flex-column border rounded-2 overflow-hidden shadow-sm" :style="{ height: height }">
...
export default {
  ...
  methods: {
    ...
    initGrid(arg) {
      ...
      warnIfRowHeightMismatch(this.gridView, this.$el, 'RealGridCommonVue')
    }
  }
}
</script>
