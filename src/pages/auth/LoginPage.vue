...
.logo { font-size: 48px; margin-bottom: 16px; font-weight: bold; }
...
.form-title { font-size: 24px; margin-bottom: 24px; color: #333; }
...
.btn-b2b-primary { background-color: #1890ff; color: white; border: none; padding: 12px; border-radius: 4px; cursor: pointer; font-size: 16px; font-weight: 500; }
.btn-b2b-primary:hover { background-color: #40a9ff; }
.block-btn { width: 100%; display: block; margin-top: 24px; }
