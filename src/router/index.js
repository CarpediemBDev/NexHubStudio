...
const UserSearGridPage = () => import("../pages/UserSearGridPage.vue");
const JqxGridPage = () => import("../pages/JqxGridPage.vue");
const CommonCodeGroupListPage = () => import("../pages/CommonCodeGroupListPage.vue");
const CommonCodeGroupDetailPage = () => import("../pages/CommonCodeGroupDetailPage.vue");
const ComponentGuidePage = () => import("../pages/ComponentGuidePage.vue");
const UserAssignmentVertical = () => import("../pages/UserAssignmentVertical.vue");
const UserAssignmentShared = () => import("../pages/UserAssignmentShared.vue");
const PostListPage = () => import("../pages/PostListPage.vue");
const PostDetailPage = () => import("../pages/PostDetailPage.vue");
const PostWritePage = () => import("../pages/PostWritePage.vue");
const FileListPage = () => import("../pages/FileListPage.vue");
const EquipmentMonitorPage = () => import("../pages/EquipmentMonitorPage.vue");
const RequestWorkflowPage = () => import("../pages/RequestWorkflowPage.vue");
const WorkRequestFormPage = () => import("../pages/WorkRequestFormPage.vue");
const PivotAltAPage = () => import("../pages/PivotAltAPage.vue");
const RealPivotPage = () => import("../pages/RealPivotPage.vue");
const RealPivotSdkPage = () => import("../pages/RealPivotSdkPage.vue");
const RealGridPage = () => import("../pages/RealGridPage.vue");
